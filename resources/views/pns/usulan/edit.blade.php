                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active p-4 border rounded" id="step-surat" role="tabpanel" aria-labelledby="step-surat-tab">
                                    ...
                                    <div class="d-flex justify-content-between mt-4">
                                        <button type="button" class="btn btn-outline-secondary btn-draft"><i class="fa fa-save me-2"></i> Simpan Draft</button>
                                ...
                                <div class="tab-pane fade p-4 border rounded" id="step-pns" role="tabpanel" aria-labelledby="step-pns-tab">
                                    ...
                                    <div class="alert alert-info p-3">
                                         Klik tombol <strong>&nbsp; Get Data <i class="fa fa-search ms-1"></i></strong> untuk mengisikan data secara otomatis.
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between mt-4">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-outline-secondary btn-draft me-2"><i class="fa fa-save me-2"></i> Simpan Draft</button>
                                ...
                                <div class="tab-pane fade p-4 border rounded" id="step-review" role="tabpanel" aria-labelledby="step-review-tab">
                                    ...
                                    <div class="alert alert-warning mt-3 p-3">
                                        <i class="fa fa-exclamation-triangle me-2"></i> Klik tombol Lanjut ke pratinjau akhir untuk meninjau keseluruhan data dan memastikan semua data sudah benar.
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between mt-4">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-outline-secondary btn-draft me-2"><i class="fa fa-save me-2"></i> Simpan Draft Baru</button>
                                            <button type="button" class="btn btn-success btn-draft" data-action="preview"><i class="fa fa-eye me-2"></i> Lanjut ke Pratinjau Akhir</button>
                                            <button type="submit" class="btn btn-primary d-none" id="btn-real-submit">Submit Langsung</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    fetch(`/test-siasn/${nip}`)
                        ...
                        .then(res => {
                            ...
                            if (res.status === 'success' && res.data && res.data.success) {
                                ...
                                document.getElementById('unor_nama').value = pns.unorNama || '';
            ...
            draftBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (isPreviewAction) {
                        ...
                        const previewFlag = document.createElement('input');
                        previewFlag.type = 'hidden';
                        previewFlag.name = 'redirect_to_preview';
                        previewFlag.value = '1';
                        form.appendChild(previewFlag);
                    }

                    // Hilangkan semua tag required karena draft memperbolehkan kolom kosong (nullable)
                    ...
                    Swal.fire({
                        title: 'Menyimpan...',
                        html: isPreviewAction ? 'Membuat draft dan menyiapkan lembar pratinjau...' : 'Menyimpan data sebagai draft...',
