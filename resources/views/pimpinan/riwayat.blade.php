            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h5 class="card-title mb-0">Daftar Riwayat Disposisi Surat (Pimpinan)</h5>
                        <h6 class="card-subtitle text-muted mt-2">Daftar surat usulan yang telah selesai diproses pelimpahannya (didisposisi).</h6>
                    </div>
                    <div class="card-body">
