            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h5 class="card-title mb-0">Daftar Surat Usulan Masuk (Pimpinan)</h5>
                        <h6 class="card-subtitle text-muted mt-2">Daftar usulan yang memerlukan disposisi dan tindak lanjut.</h6>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade" id="modalDisposisi-{{ $usulan->id_usulan }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('pimpinan.disposisi.store', $usulan->id_usulan) }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title h4"><i class="align-middle me-2" data-feather="share-2"></i> Detail & Disposisi Surat Usulan</h5>
                    ...
                    <div class="modal-body m-3">
                            ...
                            @forelse($usulan->logs as $log)
                                <li class="mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="me-3">
                                            @if(str_contains(strtolower($log->aksi), 'disposisi'))
                        ...
                        <h5 class="h6 mb-3 mt-4"><i class="align-middle me-1" data-feather="edit-2"></i> Tujuan & Catatan Pimpinan</h5>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Teruskan Kepada: <span class="text-danger">*</span></label>

                            <label class="form-check p-3 border rounded custom-radio-box mb-2">
                                <input class="form-check-input ms-0 mt-1" type="radio" value="1" name="tujuan_disposisi" required>
                                <span class="form-check-label ms-4 d-block">
                                    <strong>Kepala Bidang Mutasi (Kabid)</strong><br>
                                    <small class="text-muted">Teruskan untuk telaah manajerial bidang.</small>
                                </span>
                            </label>

                            <label class="form-check p-3 border rounded custom-radio-box">
                                <input class="form-check-input ms-0 mt-1" type="radio" value="2" name="tujuan_disposisi" required>
                                <span class="form-check-label ms-4 d-block">
                                    <strong>Staf Teknis (Verifikator Analis)</strong><br>
                                    <small class="text-muted">Langsung teruskan untuk verifikasi pemberkasan teknis.</small>
                                </span>
                            </label>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Catatan Pimpinan (Arahan):</label>
                            <textarea class="form-control" name="catatan" rows="3" placeholder="Ketik arahan atau catatan penting disini..." style="resize: none;"></textarea>
                        </div>
