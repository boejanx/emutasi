<x-app-layout>
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3">RIWAYAT VERIFIKASI MUTASI</h1>

        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h5 class="card-title mb-0">Daftar Riwayat Verifikasi</h5>
                        <h6 class="card-subtitle text-muted mt-2">Daftar berkas usulan yang sudah selesai diverifikasi.</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4"><i class="align-middle me-2" data-feather="history"></i> Rekam Jejak Usulan</h5>
